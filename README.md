...
🔍 Ручное тестирование | 🌐 REST API | 📬 SOAP | ⚛️ GraphQL | ⚡ gRPC | 🔌 WebSocket | 🚀 Postman | 🗄️ SQL | 🍃 NoSQL | 📨 Kafka | 📊 Kibana | 🐞 Sentry | 📈 Grafana | 🌲 Cypress | 🧰 WireMock | 🐳 Docker | 🔍 Charles | 🛠️ DevTools | 📋 Swagger | 🧪 Pytest | 🦊 GitLab CI/CD | 🧱 HTML | 🎨 CSS | 💛 JavaScript | 🐍 Python | 💻 VS Code | ✒️ Sublime Text | 📱 Мобильное тестирование | 🐧 Linux | 🔀 Git | 🗂️ TMS
...
[Сертификат RUS](https://github.com/user-attachments/assets/965650ee-4457-4016-8549-54517a86f2ce)
...
- 🎓 Практика и итоговый контроль (34 ч)
...
- 🎓 Изучаю автоматизацию тестирования (Python, Pytest, Requests, Cypress).
- 🤖 Пишу полезных Telegram-ботов на Python, которые помогают в повседневных задачах QA.
- 📦 Осваиваю Docker, GitLab CI/CD, Kafka и микросервисную архитектуру.
